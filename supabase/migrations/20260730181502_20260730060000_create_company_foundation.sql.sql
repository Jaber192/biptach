...
- profiles: self-or-company-member SELECT; self UPDATE; company-owner UPDATE.

## Notes
1. Drops the now-unused is_admin() function.
...
-- profiles: replace old policies with company-scoped ones
